...
def main():
    ...
    c = fiona.open('/content/boston-test-2249.geojson')
    ...
    fout = open("boston_3d_test_5.json", "w")
    fout.write(json_str)
    print("done.")
...
def output_citysjon(lsgeom, lsattributes):
    ...
    for (i,geom) in enumerate(lsgeom):
        ...
        oneb['type'] = 'Building'
        oneb['attributes'] = {}
        oneb['attributes']['bldg_id'] = lsattributes[i]['object_id']
        oneb['attributes']['bldg_storey'] = lsattributes[i]['storey']
        oneb['attributes']['bldg_type'] = lsattributes[i]['type']
        oneb['attributes']['predicted_storey'] = lsattributes[i]['predicted_storey']
        oneb['attributes']['predicted_type'] = lsattributes[i]['predicted_type']
        oneb['attributes']['estimated_height'] = lsattributes[i]['height']
        ...
        cm['CityObjects'][lsattributes[i]['object_id']] = oneb
    return cm
